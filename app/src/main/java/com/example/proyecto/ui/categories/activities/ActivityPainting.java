...
public class ActivityPainting extends AppCompatActivity {
    ...
    private ObjectCategory objectCategory = LogicCategory.objectCategories.getCategory().get(5);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (CategoriesFragment.boolPainting){
    ...
    private View.OnClickListener onClickChangeCategory = new View.OnClickListener() { //Button add delete category
        public void onClick(View root) {
            CategoriesFragment.boolPainting = !CategoriesFragment.boolPainting; //Change the value of the boolean
            finish();
        }
    };
