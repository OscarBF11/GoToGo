...
public class ActivityArchitecture extends AppCompatActivity {

    private ListView list; //fragment_subcategories list
    private FloatingActionButton selectCategory;
    private ObjectCategory objectCategory = LogicCategory.objectCategories.getCategory().get(2);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Declare the list where will appear the cleaitems
        ...
        if (CategoriesFragment.boolArchitecture) {
    ...
    private View.OnClickListener onClickChangeCategory = new View.OnClickListener() { //Button add delete category
        public void onClick(View root) {
            CategoriesFragment.boolArchitecture = !CategoriesFragment.boolArchitecture; //Change the value of the boolean
            finish();
        }
    };
