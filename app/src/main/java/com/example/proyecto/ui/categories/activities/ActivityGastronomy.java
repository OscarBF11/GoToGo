...
public class ActivityGastronomy extends AppCompatActivity {

    private ListView list; //fragment_subcategories list
    private FloatingActionButton selectCategory;
    private ObjectCategory objectCategory = LogicCategory.objectCategories.getCategory().get(3);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (CategoriesFragment.boolGastronomy){
    ...
    private View.OnClickListener onClickChangeCategory = new View.OnClickListener() { //Button add delete category
        public void onClick(View root) {
            CategoriesFragment.boolGastronomy = !CategoriesFragment.boolGastronomy; //Change the value of the boolean
            finish();
        }
    };
