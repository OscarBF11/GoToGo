...
public class ActivitySports extends AppCompatActivity {
    ...
    private ObjectCategory objectCategory = LogicCategory.objectCategories.getCategory().get(7);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (CategoriesFragment.boolSports){
    ...
    private View.OnClickListener onClickChangeCategory = new View.OnClickListener() { //Button add delete category
        public void onClick(View root) {
            CategoriesFragment.boolSports = !CategoriesFragment.boolSports; //Change the value of the boolean
            finish();
        }
    };
