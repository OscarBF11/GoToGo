...
public class ActivityUrbanArt extends AppCompatActivity {
    private ListView list; //fragment_subcategories list
    private FloatingActionButton selectCategory;
    private ObjectCategory objectCategory = LogicCategory.objectCategories.getCategory().get(6);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (CategoriesFragment.boolUrbanArt){
    ...
    private View.OnClickListener onClickChangeCategory = new View.OnClickListener() { //Button add delete category
        public void onClick(View root) {
            CategoriesFragment.boolUrbanArt = !CategoriesFragment.boolUrbanArt; //Change the value of the boolean
            finish();
        }
    };
