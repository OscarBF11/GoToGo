...
public class ActivityMusic extends AppCompatActivity {
    ...
    private ObjectCategory objectCategory = LogicCategory.objectCategories.getCategory().get(1);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (CategoriesFragment.boolMusic){
    ...
    private View.OnClickListener onClickChangeCategory = new View.OnClickListener() { //Button add delete category
        public void onClick(View root) {
            CategoriesFragment.boolMusic = !CategoriesFragment.boolMusic; //Change the value of the boolean
            finish();
        }
    };
