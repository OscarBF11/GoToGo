...
public class ActivityFilmCulture extends AppCompatActivity {

    private ListView list; // fragment_subcategories list
    private FloatingActionButton selectCategory;
    private ObjectCategory objectCategory = LogicCategory.objectCategories.getCategory().get(0);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (CategoriesFragment.boolFilmCulture) {
    ...
    private View.OnClickListener onClickChangeCategory = new View.OnClickListener() { //Button add delete category
        public void onClick(View root) {
            CategoriesFragment.boolFilmCulture = !CategoriesFragment.boolFilmCulture; //Change the value of the boolean
            finish();
        }
    };
