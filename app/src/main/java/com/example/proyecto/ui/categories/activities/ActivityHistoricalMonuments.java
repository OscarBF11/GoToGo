...
public class ActivityHistoricalMonuments extends AppCompatActivity {

    private ListView list; //fragment_subcategories list
    private FloatingActionButton selectCategory;
    private ObjectCategory objectCategory = LogicCategory.objectCategories.getCategory().get(4);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (CategoriesFragment.boolHistoricalMonuments){
    ...
    private View.OnClickListener onClickChangeCategory = new View.OnClickListener() { //Button add delete category
        public void onClick(View root) {
            CategoriesFragment.boolHistoricalMonuments = !CategoriesFragment.boolHistoricalMonuments; //Change the value of the boolean
            finish();
        }
 };
